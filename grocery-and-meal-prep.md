...
One shop, one cook, one Sunday. Everything Monday to Saturday comes out of a container you filled before the week started — the only thing you cook on a weekday is two eggs.

Portions, macros and the reasoning behind them live in [body-recomp-meal-plan.md](body-recomp-meal-plan.md). This file is what to buy and how to cook it.

---

## Contents

1. [What the Week Needs](#what-the-week-needs)
2. [Sunday Prep](#sunday-prep)
3. [What Goes in Each Container](#what-goes-in-each-container)
4. [Fridge or Freezer](#fridge-or-freezer)
5. [Where to Buy It](#where-to-buy-it)
6. [The Budget](#the-budget)
...
**Cool everything fast, then portion.** Spread the rice out thin rather than leaving it in the cooker — a warm mass of rice is the one thing in this prep that grows bacteria quickly. Everything should be in the fridge or freezer within an hour of coming off the heat.

**Weigh once, at the batch.** Every batch goes on the scale whole and is divided into servings — twelve of rice and cabbage, eight of chicken, two of dory. You never weigh a single serving, and a light batch shows up before it's in the containers instead of after.

---

## What Goes in Each Container

Twelve containers — six days, two meals each. Lunch and dinner are identical, so both containers for a day are filled the same way.
...
**Cooked chicken and rice are good for three days refrigerated, not six.** Half the week goes in the freezer on Sunday, or Saturday's lunch is a week old.

| | Fridge | Freezer |
|---|---|---|
| **Containers** | Mon, Tue, Wed — 6 | Thu, Fri, Sat — 6 |
| **Breakfast chicken** | 180g tub — Mon, Tue, Wed | 240g tub — Thu, Fri, Sat, Sun |

**Move the next day's container down to the fridge the night before.** It thaws overnight and reheats the same as a fresh one. Never thaw on the counter, and never go straight to the pan from frozen — the rice turns to paste before the chicken is warm.

Everything in this prep freezes well. Rice and chicken are unaffected. Cream dory and cabbage come back slightly softer, which is why the dory is a Thursday and the vegetable is cabbage.
...
|---|---|---|---|---|---|---|---|
| Cabbage | 3.2 kg | 25 cooked | 0 | 0 | 5.5 | 200g cooked per meal, twelve meals | ₱148 |
| Lakatan bananas | 6 large pcs | 92 | 1.0 | 0.3 | 23.0 | ½ pc, 60g peeled = 55 / 0.5 / 0 / 14 | ₱63 |
| Tomatoes | 900 g | — | — | — | — | A week of breakfasts | ₱83 |
| Onions | 500 g | — | — | — | — | Breakfast, and the pan | ₱46 |
| Garlic, ginger | a head, a thumb | — | — | — | — | 2 weeks | ₱20 |
| | | | | | | | **₱360** |

**3.2 kg of cabbage is not a mistake.** The plan eats 400g of cooked vegetables a day and cabbage loses about a quarter of its weight in the pot. It's the bulkiest thing you'll carry and the cheapest thing in the basket.
...
**Do not cut the breakfast chicken or the meat portions.** Both are load-bearing for the 145g, and the plan runs on a 1–2g margin. There is no slack anywhere else to take it out of.
