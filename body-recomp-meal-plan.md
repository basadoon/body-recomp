...
The calorie figure is your estimated maintenance, not a deficit. See [Where the Calorie Number Comes From](#where-the-calorie-number-comes-from).
...
7. [Weighing — Read This Once, Properly](#weighing--read-this-once-properly)
8. [Cooking Each Day](#cooking-each-day)
9. [Where the Oil Goes](#where-the-oil-goes)
10. [Daily Totals](#daily-totals)
11. [Sunday](#sunday)
12. [Grocery List](#grocery-list)
13. [Calcium](#calcium)
14. [Kitchen and Safety Notes](#kitchen-and-safety-notes)
15. [Where the Calorie Number Comes From](#where-the-calorie-number-comes-from)
...
**There are no split days.** Every dinner is the lunch batch reheated. Tuesday needs no cooking at all — one can of tuna, drained, at each meal.
...
Two eggs scrambled with chopped chicken breast, plus tomato, onion, bread and non-fat milk. The same every single day.

| Food | Amount | Cal | P | F | C |
|---|---|---|---|---|---|
| Whole eggs | 100g **out of the shell** (2 large) | 144 | 12 | 10 | 0.5 |
| Chicken breast, **cooked** | 60g | 99 | 18.5 | 2 | 0 |
| Tomato | 120g (1 medium) | 22 | 0 | 0 | 5 |
...
**Why 60g of chicken, and why the oil is not optional.** Dropping from four eggs to two removes 12g of protein and 10g of fat. 60g of cooked chicken breast puts back 18.5g of protein for 2g of fat and 99 calories — the most protein-efficient trade in the plan, which is how breakfast *gains* 4g of protein while gaining only 35 calories. But nothing has replaced the fat, and non-fat milk carries none either: breakfast without oil lands at 14g of fat and takes the day down to 55g, below the band. **The 2 tsp of oil is what the two eggs were doing.** You cook the eggs in it anyway, so it costs no effort.

**60g cooked is roughly 80g raw** — about a quarter of a supermarket breast fillet. It is cooked in the same batches as the lunch and dinner chicken; see [Cooking Each Day](#cooking-each-day).

### Two ways to make it

**Ginisang manok at itlog** — the default, one pan, 2 tsp oil.
...
Dice the tomato and onion raw, salt them, let them sit while the eggs boil. Soft-boil the eggs, split them over the top so the yolk runs into the salad, scatter the cold chopped chicken over, eat with the bread and milk. **This version has no oil, so it comes in 80 cal and 9g of fat lighter** — which takes the day to 55g of fat, under the band. If you make it, add those 2 tsp to that day's lunch and dinner instead. Protein is identical either way.

### Technique

**Soft-boiling.** Lower room-temperature eggs into water already at a boil. **6 minutes** for a runny yolk, **7** for jammy and easier to handle. Straight into cold water for a minute after — it stops the cooking and makes them peel cleanly. Add a minute if the eggs come from the fridge cold.

**Scrambling.** Low heat. Pull them off while they still look slightly underdone — they keep cooking for another 20 seconds. Beat a splash of your milk into the eggs first; it makes them creamier and costs nothing, since that milk is already counted. Non-fat milk does this less well than full cream, so don't expect much from it.

**Egg freshness.** Very fresh eggs are harder to peel — the white clings to the shell — so eggs a few days old actually soft-boil better than same-day ones. With only two eggs now, crack them one at a time into a separate bowl: one bad egg shouldn't take the other with it.

**Reheating the breakfast chicken.** It goes into the pan cold and already cooked, so it goes in last and only needs to come up to temperature — hot through, not browned a second time. Chicken reheated hard goes stringy. Anything past three days in the fridge, throw out; [Cooking Each Day](#cooking-each-day) sizes the blocks so that shouldn't happen.

**Runny yolks and salmonella — only relevant if you soft-boil.** A 6-minute yolk is still raw in the centre. Buy from a stall with turnover, refrigerate them at home, discard any with a cracked or dirty shell. If a batch ever gives you doubt, go **8–9 minutes** for a fully set yolk — you lose nothing nutritionally, only the texture. The default ginisa cooks the eggs through, so it sidesteps this entirely.

**On the units.** Milk stays in ml because the carton is marked that way. Slice weight varies by brand, so weigh two slices of your loaf once and adjust the 65g if needed. The breakfast chicken is weighed **cooked**, like every other piece of meat in this plan.

**Eggs are weighed out of the shell.** The 144 cal and 12g of protein are for 100g of egg, not 100g of egg-and-shell — the shell is about 6g of a large egg and contributes nothing, so weighing in-shell would leave you 1g of protein short. In practice you never need the scale for this: crack both eggs into a bowl on the scale once to see what your usual tray gives you, and after that just count two. Egg sizes vary by tray, and 100g is two large ones.

---

## Lunch and Dinner — Tanghalian at Hapunan

**These two meals are identical**, every day of the week. Cook the full day's food at lunch, eat half, refrigerate half for dinner.
...
| Lakatan banana | 60g peeled (½ pc) | 55 | 0.5 | 0 | 14 |
| **Base, before protein and oil** | | **481** | **11.5** | **1.5** | **102** |

Oil isn't in the base — it belongs to the protein, and is listed per-day in the rotation table, because the amount differs by protein.

**The banana.** Half with lunch, half with dinner. Slice it into the meal or eat it straight after — it makes no difference and it doesn't belong in the dish. Keep the second half cut-side down on a plate in the fridge; it'll discolour and taste no different. If that bothers you, buy 14 smaller bananas a week and eat a whole small one at each meal.

**The beans.** 60g drained at lunch and 60g at dinner — half a can a day, so one Molinera 400g can covers two days. **Weigh them drained** — the can is 400g gross but only ~240g of actual beans, and the numbers above are drained weight. Rinse them: it washes off ~40% of the canning sodium. Decant the unused half into a container; it keeps three days. **Every other week the beans are replaced by mixed vegetables** — see the cycle below.
...
All three are interchangeable — swap freely, the macro difference is negligible. The 40 cal in the base table is the middle of the three.

**Favour kangkong and pechay over cabbage.** They carry roughly three times the calcium, and calcium is the one thing the vegetables genuinely contribute to this plan. See [Calcium](#calcium).

**Cook them slightly under.** They soften again on reheating. Pull kangkong and pechay off the heat while still bright green; cabbage holds up best for a reheated portion.
...
> **Three proteins, not five.** Sardines and giniling are out. That simplifies shopping and cooking considerably, and it costs you one real thing: the sardine bones were most of your calcium. See [Calcium](#calcium) — that section now matters more than it did.

### Label check for the tuna

The rotation numbers assume:

| Mega tuna flakes in oil | Per 56g serving | Per 155g can |
|---|---|---|
| Protein | 13g | **36g** |
| Fat | 4g | 11g as packed · **~5g drained** |
| Calories | ~88 | 244 as packed · **~190 drained** |

**Check the servings-per-container line.** It should read about 2.8 (155g ÷ 56g). That confirms the 56g serving is the product as packed, which is what every number above is derived from. If it reads closer to 2.0, the label is quoting drained weight and the can holds more protein than this table says.

**Weigh the drained contents of one can, once.** Expect 115–125g. Protein holds at ~36g either way — it's in the fish, not the oil — but the drained fat figure is the soft one, since flakes hold oil better than chunks. Anything much lighter than 115g means more oil came off than assumed.

**Sodium runs 400–500mg a can**, so expect the scale up a pound the morning after Tuesday. That's water, not fat.

---

## Weighing — Read This Once, Properly

**Weigh all meat and fish cooked**, off the pan, after any fat is drained. Rice too. These are the raw amounts those cooked weights come from, which is what you actually buy:
...
**In practice: weigh the batch once, cooked, then halve it.** Cook the full day's meat, put it all on the scale, split it down the middle for lunch and dinner. You never need to weigh a single serving.

**On chicken days, take the breakfast chicken off first.** Weigh out that block's portion, chop it, put it in its own container — then weigh what's left and halve that for lunch and dinner.

**Tuesday needs no scale.** One can is one serving.
...
**Breakfast chicken is cooked four times a week, alongside that day's lunch batch.** Cook it plain — poached or dry-panned, no oil, no seasoning that would fight with eggs — then weigh it, chop it, and keep it in its own container. Four short blocks cover the week:

| Cooked on | Covers | Cooked | Raw |
|---|---|---|---|
| **Mon** | Mon, Tue breakfasts | 120g | ~160g |
| **Wed** | Wed, Thu breakfasts | 120g | ~160g |
| **Fri** | Fri, Sat breakfasts | 120g | ~160g |
| **Sat** | Sunday breakfast | 60g | ~80g |

**Nothing sits in the fridge more than two days now.** With chicken cooked four times a week instead of three, the blocks got shorter — comfortably inside the three-day limit for cooked chicken, with a day to spare. And because it goes into the breakfast pan already cooked, it only needs warming through.

**Tuesday is the only day you don't cook at all.** Open one can of tuna per meal, drain it, fold it through the rice, beans and vegetables. Nothing gets batched, nothing gets reheated. The 1 tsp of oil per meal goes into the vegetables.

**Refrigerate the dinner portion within an hour of cooking** — not after it cools on the counter. See [Kitchen and Safety Notes](#kitchen-and-safety-notes).
...
**Every meal gets some.** Breakfast takes 2 tsp every day — with two eggs instead of four, and non-fat milk carrying none, the oil is the only fat on that table.
...
**Tuesday gets 1 tsp a meal**, and it goes into the vegetables rather than the fish. Drained oil-packed tuna still carries ~5g of fat per can, so it doesn't need starting in a pan the way water-packed did.
...
Assumes the default ginisa breakfast with its 2 tsp of oil. Subtract 80 cal and 9g of fat on any day you soft-boil instead.

These are maintenance numbers, not a deficit — see [Where the Calorie Number Comes From](#where-the-calorie-number-comes-from).

Each macro cell shows **grams · share of that day's calories**.
...
Three stops. **Macros are per 100g or 100ml, the way labels print them**, so you can hold two brands side by side on the shelf and compare. Raw vegetables and raw meat are left blank — there's no label to compare on those.
...
- **Tuna** — Mega tuna flakes in oil, 155g. Check the label reads 13g protein and 4g fat per 56g serving, at about 2.8 servings a can. See the rotation notes for why that servings figure matters.
- **Beans** — drained weight should be ~240g of a 400g can. Much less and it's mostly brine.
...
| Item | Qty/week | Cal/100g | P | F | C | Plan serving (cal / P / F / C) | Cost |
|---|---|---|---|---|---|---|---|
| Eggs | 1 tray (30) — lasts 2 weeks | 144 | 12.0 | 10.0 | 0.7 | 2 eggs, 100g out of the shell = 144 / 12 / 10 / 0.5 | ₱125 |
...
Produce only. Go early morning; it's usually 30–40% cheaper than the supermarket.
...
**Every day lands near 615mg**, against the 1,000mg you want — and unlike before, there is no longer a single day that makes up the difference:

| Source | mg |
|---|---|
| Non-fat milk, 250ml | ~310 |
| Pechay or kangkong | ~150 |
| Eggs (2) | ~53 |
| Bread | 50 |
| Kidney beans (60g × 2) · or mixed vegetables (115g × 2) | 42 |
| Chicken breast | ~10 |
| **Total** | **~615** |

**This section now matters more than any other in the plan.** Two changes made it worse and nothing made it better: halving the beans cost 42mg a day, and — far bigger — **dropping sardines removed the only real calcium source in the week.** Tuesday used to land near 1,450mg on two cans of soft sardine bones, roughly 800mg of calcium a week that is simply gone. Every day is now short by about the same amount, with no day compensating.

**Non-fat milk loses no calcium** — skimming removes the fat, not the minerals, so it carries the same ~125mg per 100ml as full cream, sometimes marginally more.

**Tuna brings no calcium at all** — it's boneless, which is the trade for how lean and convenient it is. Tuesday is now no better than any other day.

Three ways to close the gap. **None of them touch the protein:**
...
## Kitchen and Safety Notes

**Refrigerate the dinner portion within an hour of cooking**, not after it cools on the counter. Cooked rice left at room temperature grows *Bacillus cereus*, and reheating does not destroy its toxin.

**Cooked chicken keeps three days in the fridge** — which is why the breakfast chicken is cooked in four short blocks rather than one weekly batch. None of them exceeds two days. Get it into a covered container within an hour of cooking, same as the dinner portions. If a block ever outlives its days, throw it out and eat four eggs that morning instead; one breakfast 6g lighter on protein won't hurt you.

**Never store an opened can in the tin** — tuna, beans or mixed vegetables alike. Decant into a container, refrigerate, use within 3 days. This matters on bean weeks, where half a can is always open in the fridge; on mixed-vegetable weeks the can is exactly one day and nothing is left over.

**Canned beans are safe as they are** — already fully cooked. Rinse, drain, eat.

**Dry kidney beans, if you ever switch to save money, must be boiled hard.** Soak 8+ hours, discard the soaking water, then a full rolling boil for at least 10 minutes before simmering to done. Raw and undercooked red kidney beans contain phytohaemagglutinin — severe vomiting and cramps within hours, from as few as four or five beans. Beans held at low temperature without that hard boil are ***more*** toxic than raw, so **never use a slow cooker or rice cooker for them.**

**Fibre is now on the low side.** At 60g of beans a meal you get about 9g of fibre a day from them, half what the plan used to deliver — and on mixed-vegetable weeks about 6g, because the mix carries less than the beans do. That's easier on your gut than the old 18g, but it's below what you want overall. The vegetables and the whole-wheat bread carry the rest; favour kangkong and pechay, keep the 200g of vegetables honest, and don't be tempted to trim them.

**Cholesterol and two eggs a day.** Barely worth raising now. Dietary cholesterol has a much smaller effect on blood cholesterol than was assumed for decades, and two eggs a day is unremarkable by any current standard — the swap to chicken halved the question before it was asked. The rest of the plan is genuinely low in saturated fat: non-fat milk, chicken breast and fish, with no pork at all any more. If you have a family history of high cholesterol, get a lipid panel before you start and another at three months; that turns the question into data instead of opinion.
...
**NEAT is your largest remaining lever.** With one ride a week and a desk job, a 30-minute daily walk would add ~120 cal/day — which buys you more food rather than taking it away.
...
- **Waist at the navel**, same time of day, once a week. Your best single fat-loss signal.
- **Your logbook.** More reps or more weight at the same bodyweight is muscle, near enough by definition.
- **Photos monthly**, same light, same spot. Slow change is invisible day to day and obvious across eight weeks.

Realistic pace is **0.5–1 lb of muscle a month** if you're new to lifting or returning after a break, with similar fat loss alongside. Slower than either pure bulking or pure cutting — that's the price of doing both at once.

**If your average weight is stable and your lifts are climbing, the plan is working.** That's the whole test.

| If... | Then |
|---|---|
| Weight drops more than ½ lb a week | Add 150 calories |
| Weight climbs steadily over three weeks | Cut 150 calories — **from rice, not protein** |
| Weight stable, lifts climbing | Change nothing |

**Take progress photos monthly.** During a recomp the scale barely moves, so photos and your training log are the real measures — not the number on the scale.
