...
What to buy and how to cook it is in [grocery-and-meal-prep.md](grocery-and-meal-prep.md).
...
8. [Where the Oil Goes](#where-the-oil-goes)
9. [Daily Totals](#daily-totals)
10. [Sunday](#sunday)
11. [Where the Calorie Number Comes From](#where-the-calorie-number-comes-from)
...
1. **145g of protein, Monday to Saturday.** This is the number the whole plan is built around. It's a target you hit, not a floor with slack — a normal day lands at 146–147g, Tuesday a little under at 142g. 145g is 2.0g per kg of bodyweight at 160 lbs, inside the 1.6–2.2 range the evidence supports for building muscle. **Sunday is untracked past breakfast** and lands nearer 120g; see [Sunday](#sunday).
...
The only thing that changes across the week is the protein at lunch and dinner. Breakfast never changes — its chicken comes off the same Sunday air fryer batch as everything else, so it adds no separate shopping and almost no extra work. The rice, vegetables and banana never change.

**Nothing is cooked on a weekday except two eggs.** Lunch and dinner are reheated from Sunday's containers; breakfast is a five-minute pan with the chicken already cooked. See [grocery-and-meal-prep.md](grocery-and-meal-prep.md).

---

## How Every Day Reaches 145g

Everything except the day's meat is fixed, Monday to Saturday:
...
**Strictly, each serving needs 37.5g.** The rotation sizes them at 38–38.5g, which lands a normal day at 146–147g rather than exactly 145. That 1–2g is the whole of your margin — this plan carries no real buffer beyond it, so a sloppy weighing costs you. Weigh properly and the target looks after itself.

**The breakfast chicken is load-bearing.** With vegetables logged at zero, breakfast supplies a third of your daily protein before you cook anything — and its 60g of chicken out-proteins the two eggs it sits with. Skipping it costs 18.5g a day and puts every day under target.
...
**These two meals are identical**, every day of the week. Two containers a day, filled the same way, reheated twelve hours apart.
...
**It's a straight drop-in — nothing else moves.** Jolly mixed vegetables carry 9g of protein and 27g of total carbohydrate per 230g can. At 115g that's 4.5g of protein and 13.5g of carbs, against the kidney beans' 5g and 13.5g: **the carbohydrate matches to the gram** and the protein is half a gram light. Calories land within one of each other. The rice stays at 240g, the rotation stays the same, and **calories, carbs and Sunday's budget hold across both weeks — protein is the only thing that moves.**

**One can a day, 115g at lunch and 115g at dinner.** That's 6 cans a week, and the 230g can divides into exactly one day's two containers with nothing left over.
...
All three are interchangeable — swap freely, the macro difference is negligible. The 40 cal and 7g of carbs in the base table are the average of the three.

**Cabbage is the one that prepped food wants.** Kangkong and pechay are limp and grey by midweek; cabbage reheats on day six the same as on day one. Use the leafy ones when you're cooking fresh on the day.
...
**Take the breakfast chicken off the top.** It's the same air fryer batch as everything else, so weigh all ~1,420g cooked, set 420g aside and chop it, then portion what's left into the eight chicken meals.
...
**Sunday is the ride day and the untracked one.** Its ~2,430 is not a cheat on top of maintenance — the six weekdays each run ~34 under, and the ~200 that banks is spent here. The figures in its row are an estimate of two ordinary meals out, not a prescription. See [Sunday](#sunday).

---

## Sunday

**Breakfast is the only tracked meal.** Lunch and dinner are both free — nothing to weigh, nothing to log. It's also the day you ride, and the day you cook the week.
...
**2,227 a day is your estimated maintenance — what you burn, not a deficit.** Eat it and you hold 160 lbs. That is the point: a recomp replaces fat with muscle at a stable bodyweight, so the scale not moving is the plan working, not the plan failing.

| | Cal/day |
|---|---|
| BMR — Mifflin–St Jeor at 72.6 kg, 175 cm, age 27 | 1,690 |
| Sedentary baseline — desk-bound, low step count | +350 |
| 3 lifting sessions/week, ~180 net each, averaged over 7 days | +77 |
...
**The lifting sessions are worth less than they feel like.** Forty minutes of dumbbell work at moderate loads is about 4–5 METs, which is ~230 calories gross and **~180 net** of what you'd have burned sitting. Treadmill-style estimates and watch figures routinely double this. The number rises as the weights do — recheck it when you're lifting something heavier.
